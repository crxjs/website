<template>
  ...
  >
    ...
    <div
      ...
      :class="[
        padded &&
          ($slots.default?.()[activeTabIndex]?.type as any).tag !== 'pre' &&
          'p-3',
      ]"
    >
...
import ScrollBar from "shadcn-docs-nuxt/components/ui/scroll-area/ScrollBar.vue";
